...
layout = [
    [sg.Text("COMPUTED AIR RELEASE POINT - PYTHON CALCULATOR",font=("Lato",14,'bold'))],
    [sg.Text("Para dados decimais, favor inserir ponto \'.\' ao invés de vírgula.",font=("Arial",11,"italic"))],
    [sg.Text("\nDADOS GERAIS",font=("Lato",13,'bold'))],
    [sg.Text("Posto e Nome de Guerra:",size=(32,1)),sg.Input(key='name')],
    [sg.Text("Trigrama:",size=(32,1)),sg.Input(key='trigram')],
    [sg.Text("ALTURA do lançamento (ft):",size=(32,1)),sg.Input(key='drop_height')],
    [sg.Text("ALTITUDE da ZL (ft):",size=(32,1)),sg.Input(key='terrain_alt')],
    [sg.Text("ALTITUDE do Ponto de Impacto (ft):",size=(32,1)),sg.Input(key='point_of_impact')],
    [sg.Text("Pressão (HPa):",size=(32,1)),sg.Input(key='pressure')],
    [sg.Text("Temperatura na altitude de lançamento (°C):",size=(32,1)),sg.Input(key='temperature')],
    [sg.Text("Velocidade do lançamento (kt): ",size=(32,1)),sg.Input(key='speed')],
    [sg.Text("Eixo de Lançamento (°):",size=(32,1)),sg.Input(key='mag_course')],
    [sg.Text("\nDADOS BALÍSTICOS",font=("Lato",13,'bold'))],
    [sg.Text("Tipo do paraquedas:", size=(32, 1)), sg.Combo(chute_name_list,size=(43,1),key='chute_selection',default_value="T-10 AC/RAC")],
    [sg.Text("Quantidade de paraquedas:", size=(32, 1)), sg.Input(key='chute_amount',default_text='1')],
    [sg.Text("Rate of fall (RF):", size=(32, 1)), sg.Input(key='rate_of_fall',default_text='14.5')],
    [sg.Text("Vertical Distance (VD):", size=(32, 1)), sg.Input(key='vertical_distance',default_text='180')],
    [sg.Text("Deceleration Quocient (DQ):", size=(32, 1)), sg.Input(key='dec_quocient',default_text='1.6')],
    [sg.Text("Time of Fall Constant (TFC):", size=(32, 1)), sg.Input(key='tfc',default_text='5.4')],
    [sg.Text("Exit Time (ET):", size=(32, 1)), sg.Input(key='exit_time',default_text='0.2')],
    [sg.Text("")],
    [sg.Text("Unidade de Medida:",size=(32,1)),sg.Radio('Metros',"unit",key='measure_unit_m',default=True),sg.Radio('Jardas','unit',key='measure_unit_j')],
    [sg.Text('')],
    [sg.Submit(button_text="Enviar")]
]

window = sg.Window('#TAL CARP - v 0.8',layout)
...
try:
    ...
    sg.popup("Erro de Preenchimento. Favor reiniciar o programa",title="ERRO")
...
try:
    ...
    class PDF(FPDF):
        ...
        def my_footer(self):
            ...
            #self.text(xc-33,doc_height-28,"Na instrução, o Rumba é Rei!")
    ...
    pdf.add_page()
    pdf.set_author("Ten Thales - Rumba é Rei!")
